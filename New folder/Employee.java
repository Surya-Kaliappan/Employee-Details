...
public class Employee implements ActionListener{
    ...
    public void addEmployee(){
        ...
        l5.setBounds(105,295,110,30);
        l5.setFont(font);

        emp_spec = new JComboBox(spec);
        emp_spec.setBounds(220,295,290,30);
        emp_spec.setFont(font);

        JLabel l4 = new JLabel("*Department");
        l4.setBounds(60,355,110,30);
        l4.setFont(font);
        ...
        emp_dept = new JComboBox();
        emp_dept.setBounds(190,355,340,30);
    ...
    public void editEmployee(){
        ...
        showspec.setBounds(90,310,110,30);
        showspec.setFont(font);
        showspec.setEnabled(false);

        emp_spec = new JComboBox(spec);
        emp_spec.setBounds(205,310,330,30);
        emp_spec.setFont(font);
        emp_spec.setEnabled(false);

        showdept = new JLabel("*Department");
        showdept.setBounds(50,365,110,30);
        ...
        emp_dept = new JComboBox();
        emp_dept.setBounds(180,365,375,30);
        emp_dept.setFont(font);
        emp_dept.setEnabled(false);
    ...
    private void collectData(String row){
        try{
            ...
            Statement stmt = con.createStatement();
            if(checkId(row)){
                String query = "Select emp_name,emp_dept,emp_spec,emp_ph,emp_email from employee where emp_id='"+row+"';";
                ResultSet rs = stmt.executeQuery(query);
                rs.next();
